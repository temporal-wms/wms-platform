...
type PlanningWorkflowInput struct {
	...
	UseUnitTracking    bool                   `json:"useUnitTracking"`
...
func PlanningWorkflow(ctx workflow.Context, input PlanningWorkflowInput) (*PlanningWorkflowResult, error) {
	...
	// ========================================
	// Step 2: Persist Process Path (if unit tracking enabled)
	// ========================================
	if input.UseUnitTracking {
		...
		if err != nil {
			...
			// Non-fatal: continue without persisted path
